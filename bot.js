...
const messages = {
  ...
  returnInfo:
    '\nУважаемый клиент!\nМы стремимся сделать процесс возврата удобным и прозрачным для вас.\n\nПожалуйста, ознакомьтесь с инструкцией, чтобы Ваш запрос был обработан как можно быстрее. \n\nВы можете оформить возврат по следующим причинам:\n\n1. Заводской брак\n2. Некомплект\n3. Повреждение\n4. Б/У\n5. Некорректная замена\n6. Неверное вложение/пересорт\n7. Недостача/Излишек\n8. Деталь не подошла\n9. Ошибка подбора.\n\nВозврат возможен в течение 14 дней с момента получения детали.\n\nДля оформления возврата убедитесь, что:\n1. Деталь сохраняет товарный вид;\n2. Все стикеры производителя и поставщика присутствуют.\n\nКак оформить возврат?\n1. Укажите референс Вашего заказа в данном чате или отправьте запрос на нашу почту.\n2. Предоставьте фотографии детали, чтобы мы могли быстро оценить ситуацию.\n3. После получения запроса от вас мы составляем официальный запрос поставщику на возврат. Это необходимо для дальнейшего согласования возврата и компенсации.\n\nОбработка возвратов может занимать разное время, так как согласование с поставщиком требует индивидуального подхода к каждому случаю.',
